...
INSERT INTO `aluno` VALUES (50230123,'valenthina','3h','2007-01-02 00:00:00'),(50230321,'muca','3h','2007-01-01 00:00:00'),(50230369,'heitor','3h','2007-11-05 00:00:00'),(50230552,'thiag','2h','11/03/2008');
...
CREATE TABLE `atestado` (
  `idAtestado` int unsigned NOT NULL AUTO_INCREMENT,
  `Aluno_matricula` int unsigned NOT NULL,
  `dataInicio` date DEFAULT NULL,
  `dataFim` date DEFAULT NULL,
  `obs` varchar(45) DEFAULT NULL,
  `abonaFalta` tinyint DEFAULT NULL,
  `nomeMedico` varchar(45) DEFAULT NULL,
  `CRM` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idAtestado`),
  UNIQUE KEY `idAtestado_UNIQUE` (`idAtestado`),
  KEY `fk_Atestado_Aluno1_idx` (`Aluno_matricula`),
  CONSTRAINT `fk_Atestado_Aluno1` FOREIGN KEY (`Aluno_matricula`) REFERENCES `aluno` (`matricula`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `funcionario` VALUES (1,'reis','12345780','12345',1);
...
CREATE TABLE `ocorrencia` (
  ...
  `Funcionario_registro_Orientador` int unsigned NOT NULL,
  `Funcionario_registro_Professor` int unsigned NOT NULL,
  `reladoFuncionario` varchar(45) DEFAULT NULL,
  `relatoAluno` varchar(45) DEFAULT NULL,
  `condutaOrientacao` varchar(45) DEFAULT NULL,
  `StatusOcorrencia_idStatusOcorrencia` int unsigned NOT NULL,
  `momento` datetime DEFAULT NULL,
  `Ocorrenciacol` varchar(45) DEFAULT NULL,
  ...
  KEY `fk_Ocorrencia_StatusOcorrencia1_idx` (`StatusOcorrencia_idStatusOcorrencia`),
  ...
  CONSTRAINT `fk_Ocorrencia_StatusOcorrencia1` FOREIGN KEY (`StatusOcorrencia_idStatusOcorrencia`) REFERENCES `statusocorrencia` (`idStatusOcorrencia`),
...
CREATE TABLE `responsavel` (
  ...
  `emailMae` varchar(45) DEFAULT NULL,
...
--
-- Table structure for table `statusocorrencia`
--
...
CREATE TABLE `statusocorrencia` (
  `idStatusOcorrencia` int unsigned NOT NULL AUTO_INCREMENT,
  `status` varchar(45) DEFAULT NULL COMMENT 'Encaminhada pelo Professor\nPais Avisados\nFinalizado\n',
  PRIMARY KEY (`idStatusOcorrencia`),
  UNIQUE KEY `idstatusOcorrencia_UNIQUE` (`idStatusOcorrencia`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `statusocorrencia`
--

LOCK TABLES `statusocorrencia` WRITE;
/*!40000 ALTER TABLE `statusocorrencia` DISABLE KEYS */;
/*!40000 ALTER TABLE `statusocorrencia` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tipofuncionario` VALUES (1,'inspetor');
...
-- Dump completed on 2025-02-26 18:47:35
